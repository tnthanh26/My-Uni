...
## 📌 Project Overview
- **Name:** My-Uni
- **Core Purpose:** An Academic Companion application designed to support university students throughout their daily campus life, course progression, study schedules, deadlines, 1-to-1 peer chat, and social/official campus activities.
...
- **Core Capabilities:** 
  ...
  - **Gemini Assistant:** Integrated AI chatbot ("Ú Em") powered by Google Generative AI & proxy Cloud Functions to answer student queries.
  - **Campus & Social Hub:** Official announcements, student discussion forum tabs with unnumbered `"Sinh viên ẩn danh"` authors, smart feed auto-reload on self actions, faculty daily news digests, shared study materials, and peer course reviews.
  - **Peer Messaging & Retention:** Real-time 1-to-1 direct messaging, photo/file attachments, contact sharing, room reporting & deletion (`deleteChatRoom`), automated 30-day message cleanup retention policy with 12h rate limiting, and push notification center.
  - **Standardized Action Dialogs & Feedback:** Unified bottom sheets (`AppActionDialogs.showActionBottomSheet`) and confirm dialogs (`AppActionDialogs.showConfirmDialog`), optimized SnackBar feedback rules (silenced when UI reflects action directly).
  - **Campus Events & Attendance:** Event discovery by category, personal/community event creation, user RSVP bookmarks, and hardware QR scanner attendance check-ins.
...
- **AI Integration:** Google Generative AI (`google_generative_ai`) proxying to an external Python FastAPI / Azure V2 backend via Cloud Functions.
...
- **Routing:** 
  - **Mobile:** Named native routing (implemented in [main.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/main.dart) & [splash_screen.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/splash_screen.dart)).
  - **Web:** GoRouter (`go_router`) with path strategies and auth-state redirection rules (implemented in [main.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/main.dart) & [main_web_student_demo.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/main_web_student_demo.dart)).
...
- [otp_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/credential/otp_page.dart) & [forgot_password_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/credential/forgot_password_page.dart): Recovery and validation via EmailJS 6-digit OTP codes.
...
- [official_tab.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/official_tab.dart) & [official_content_helper.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/official_content_helper.dart): Displays official university announcements and event feeds.
- [daily_digest_card.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/daily_digest_card.dart): Retrieves and displays daily generative AI summaries of general announcements.
- [faculty_daily_digest_card.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/faculty_daily_digest_card.dart) & [faculty_helper.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/faculty_helper.dart): Provides faculty-tailored daily news digests based on student major/faculty.
- [forum_tab.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/forum_tab.dart): Social feed allowing students to read/write posts, participate in polls, and discuss campus topics. Enforces unnumbered `"Sinh viên ẩn danh"` display for post authors while keeping `#001-#999` numbers for comment participants. Implements Smart Feed Auto-Reload: immediately brings self-created posts (`Navigator.pop(context, true)`) to the top and removes deleted posts from memory (`_sortedPostIds` / `_cachedPostsMap`) while freezing reading positions during external post creation.
- [material_tab.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/material_tab.dart): Repository for uploading and downloading student study guides, slides, and files.
- [review_tab.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/review_tab.dart): Feedback loop containing reviews of classes, lecturers, and courses.
- [create_post_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/create_post_page.dart) / [create_material_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/create_material_page.dart) / [create_review_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/create_review_page.dart): Forms to submit content, posts, reviews, or materials. Features real-time autocomplete suggestions for course and lecturer inputs using [CourseTeacherData](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/utils/course_teacher_data.dart) and [SearchableAutocompleteField](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/widgets/searchable_autocomplete_field.dart). Runs pre-submit checks against a local sensitive-word blacklist and returns `true` on pop to trigger feed refresh.
- [post_detail_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/post_detail_page.dart) / [post_action_row.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/post_action_row.dart): Renders detailed post discussions with nested comment trees. Features real-time Firestore stream subscriptions (`snapshots()`) for instant post edit updates, action options via `AppActionDialogs.showActionBottomSheet`, and `Navigator.pop(context, true)` upon deletion.
...
- [myspace_screen.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/myspace/myspace_screen.dart): Interactive dashboard displaying class calendars, task lists, and weather conditions. Features a 24-hour grid (`00:00` to `23:00`) with smooth auto-scroll focus to the first class of the day. Uses `AppActionDialogs` for schedule and personal event action menus.
...
- **Services:**
    ...
    - [welcome_banner_service.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/myspace/services/welcome_banner_service.dart): Manages banner messages and daily motivation greetings.

### 4. Events (`lib/features/event/`)
Event discovery, category browsing, RSVP tracking, and attendance scanning.
- [event_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/event/event_page.dart): Tab controller shell for organizing event sub-pages.
- [discover_event_tab.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/event/discover_event_tab.dart): Aggregates active events sorted by category (Tech, Art, Graduation, etc.).
- [my_event_tab.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/event/my_event_tab.dart) & [interested_event_tab.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/event/interested_event_tab.dart): Tracks user-registered and bookmarked events. Features `AppActionDialogs.showActionBottomSheet` for event edit/delete options.
- [student_attendance_history_tab.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/event/student_attendance_history_tab.dart): Lists past events attended by the student with check-in timestamps.
- [create_personal_event_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/event/create_personal_event_page.dart) & [create_community_event_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/event/create_community_event_page.dart): Allows scheduling personal calendar items or requesting official event listings.
- [event_qr_scanner_dialog.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/event/event_qr_scanner_dialog.dart): Dialog utilizing hardware camera scan logic for student event attendance.

### 5. Chat 1-to-1 Messaging (`lib/features/chat/`)
Peer-to-peer real-time chat and student messaging network.
- [chat_list_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/chat/pages/chat_list_page.dart): Conversations inbox rendering active chats, last message previews, unread badges, and user online status. Triggers global chat retention cleanup `cleanupAllUserExpiredChats()` on initialization.
- [chat_detail_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/chat/pages/chat_detail_page.dart): Direct messaging screen with Firestore real-time streams (`snapshots()`), message delivery status, image/file sharing, contact card sharing, and AppBar `⋮` options menu for room reporting and conversation deletion (`deleteChatRoom`). Triggers room cleanup `cleanupExpiredMessages()` on initialization.
- [search_user_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/chat/pages/search_user_page.dart): User lookup screen by name, email, or student ID to initiate new 1-to-1 conversations.
- **Services:** [chat_service.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/chat/services/chat_service.dart): Firestore real-time messaging pipeline, chat room initialization, message read receipts, `deleteChatRoom` with batch message & notification deletion, and `cleanupExpiredMessages` / `cleanupAllUserExpiredChats` background retention engine for messages older than 30 days with a 12-hour rate limiter.

### 6. Notifications (`lib/features/notification/`)
Central hub for activity updates and direct message alerts.
- [notification_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/notification/notification_page.dart): System-wide notification center rendering post likes, comments, moderation notices, and campus announcements.
- [message_notification_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/notification/message_notification_page.dart): Dedicated inbox tab for incoming message alerts and chat request notifications.

### 7. AI Chatbot (`lib/features/chatbot/`)
- [chatbot_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/chatbot/chatbot_page.dart): Chat window using the Gemini SDK to answer student questions and offer learning guidance. Queries are proxied through the rate-limited `chatWithUEm` Cloud Function backend.

### 8. Course & Site Search (`lib/features/search/`)
- [myuni_search_delegate.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/search/myuni_search_delegate.dart): Global search engine using Flutter SearchDelegate to search courses, forum posts, and pages. Proxies queries to the `semanticSearch` Cloud Function.
...
### 9. Profile & Settings (`lib/features/account/`)
- [account_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/account/account_page.dart): Profile overview showing student information, activity statistics, and settings links.
- [setting_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/account/setting_page.dart): Allows switching languages and toggling dark mode. Updates [app_provider.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/app_provider.dart) states.
- [change_password_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/account/change_password_page.dart) / [edit_profile_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/account/edit_profile_page.dart): Profile configuration details.
- [my_post_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/account/my_post_page.dart): Dedicated management view for student's own published forum posts.
- [my_review_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/account/my_review_page.dart): Management view for student's course and teacher reviews.
- [saved_posts_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/account/saved_posts_page.dart): Bookmarked/saved forum posts list.
- [social_contacts_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/account/social_contacts_page.dart): Student social network connections.
- [user_search_widget.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/account/user_search_widget.dart): Reusable student search and profile preview widget.
...
### 10. Data Models (`lib/models/`)
Strongly typed Flutter models mapping JSON/Firestore documents:
- [event_model.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/models/event_model.dart): Structured data schema for campus events, RSVP limits, categories, and locations.
- [notification_model.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/models/notification_model.dart): Schema for activity notifications, sender metadata, payload links, and read flags.

### 11. Global Services & Helpers (`lib/features/services/` & `lib/utils/`)
- [app_action_dialogs.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/widgets/app_action_dialogs.dart): Standardized app-wide UI components providing `AppActionDialogs.showActionBottomSheet` (drag-handle mobile bottom sheet for item actions) and `AppActionDialogs.showConfirmDialog` (styled confirmation dialogs for dangerous delete operations).
- [anonymous_utils.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/utils/anonymous_utils.dart): Utility formatting unnumbered `"Sinh viên ẩn danh"` labels for post authors while maintaining hashed `#001-#999` numbers for comment participants.
...
### 12. Web Moderation & Collaborator Panels (`lib/web_mod/`)
...
- [mod_login_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/web_mod/mod_login_page.dart): Login portal for moderation team members.
...
- [student_qr_scanner_dialog.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/web_mod/student_qr_scanner_dialog.dart): Web-compatible dialog for scanning student attendance QR codes.
- [file_helper_web.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/web_mod/file_helper_web.dart) & [file_helper_stub.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/web_mod/file_helper_stub.dart): Cross-platform file handling abstractions for web uploads.
...
The serverless backend logic written in TypeScript governs moderation, chatbot security/caching, semantic search proxy, and account registration.
...
- **Rate-Limited Chat Proxy (`chatWithUEm`):**
  Secures and restricts Gemini chatbot requests to **10 questions per user per day**. Hashes prompt keys (MD5) and stores responses in a 30-day cache database (`chat_cache`) to optimize costs. Dynamic server URL configuration fetched from Firestore document `system_config/chatbot` (defaults to Azure V2 endpoint) with 45-second timeout via `AbortController`.
- **Semantic Search Proxy (`semanticSearch`):**
  A Callable cloud function proxying semantic text searches to the search server URL configured in `system_config/search`. Supports `query`, `scope`, `tag`, and `sort` parameters.
- **Registration OTP System (`sendRegistrationOTP`, `verifyOTPAndCreateUser`):**
  Validates university email domain ownership. Sends 6-digit verification codes via an EmailJS proxy integration (`template_3ftz8sr` for OTP, `template_4g8950q` for duplicate email notice) with 5-minute TTL in Firestore `pending_otps`. On verification, registers the authentication user, creates profile details, returns a custom token, and features full rollback safety (deletes Auth account and Firestore document if errors occur).
...
- **Mobile app:** Normal MaterialApp routing (`initialRoute: '/'`) using a predefined routes map.
  - Starts with [splash_screen.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/splash_screen.dart) (`/`), which routes to `/welcome` or `/home` based on logged-in state.
