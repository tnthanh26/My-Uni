...
- **Core Capabilities:** 
  ...
  - **Campus & Social Hub:** Official announcements, student discussion forum tabs, faculty daily news digests, shared study materials, and peer course reviews.
  - **Peer Messaging & Notifications:** Real-time 1-to-1 direct messaging, online presence tracking, photo attachments, and push notification center.
...
- [forum_tab.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/home/forum_tab.dart): Social feed allowing students to read/write posts, participate in polls, and discuss campus topics.
...
- [my_event_tab.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/event/my_event_tab.dart) & [interested_event_tab.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/event/interested_event_tab.dart): Tracks user-registered and bookmarked events.
...
- [chat_list_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/chat/pages/chat_list_page.dart): Conversations inbox rendering active chats, last message previews, unread badges, and user online status.
- [chat_detail_page.dart](file:///c:/Users/TUF/StudioProjects/My-Uni/lib/features/chat/pages/chat_detail_page.dart): Direct messaging screen with Firestore real-time streams (`snapshots()`), message delivery status, image sharing, quote replies, and message actions.
...
- Services & Models: Firestore real-time messaging pipeline, chat room initialization, and message read receipts.
