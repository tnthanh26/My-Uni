                ...
                child: Column(
                  ...
                  children: [
                    ListTile(
                      ...
                      subtitle: Text(data['date'] ?? '', style: const TextStyle(fontSize: 12, color: Colors.grey)),
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(color: const Color(0xFF6797E1).withOpacity(0.1), borderRadius: BorderRadius.circular(15)),
                              child: const Text("# Sự kiện", style: TextStyle(color: Color(0xFF6797E1), fontSize: 12, fontWeight: FontWeight.bold)),
                            ),
                            // Chặn chạm ở nút Sự kiện
                            GestureDetector(
                              onTap: () {},
                              child: StreamBuilder<DocumentSnapshot>(
                                  ...
                                  builder: (context, favSnapshot) {
                                    ...
                                    return ElevatedButton(
                                      ...
                                      child: Text(isInterested ? 'Đã quan tâm' : 'Quan tâm', style: const TextStyle(fontSize: 12)),
                                    );
                                  }
                              ),
                            ),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(summary, maxLines: 4, overflow: TextOverflow.ellipsis, style: TextStyle(color: isDarkMode ? Colors.white70 : Colors.grey[800], height: 1.4)),
                        ],
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset('assets/images/news.png', width: double.infinity, height: 180, fit: BoxFit.cover),
                      ),
                    ),

                    // CHẶN CHẠM Ở THANH ACTION ĐỂ KHÔNG NHẢY DETAIL KHI LIKE/LƯU
                    GestureDetector(
                      onTap: () {},
                      ...
                      child: SizedBox(
                        ...
                        child: OutlinedButton(
                          ...
                          style: OutlinedButton.styleFrom(
                            ...
                            side: BorderSide(color: isDarkMode ? const Color(0xFF91B5EE) : const Color(0xFF6797E1)),
                          ),
                          child: Text('Xem chi tiết bài viết', style: TextStyle(color: isDarkMode ? const Color(0xFF91B5EE) : const Color(0xFF6797E1), fontWeight: FontWeight.bold)),
                        ),
                      ),
                    ),
                  ],
