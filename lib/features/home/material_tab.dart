                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // PHẦN FILE CŨ CỦA BẠN (vẫn giữ logic mở file riêng)
                        if (fileData != null && fileData.isNotEmpty)
                          GestureDetector(
                            onTap: () {
                              // Chặn sự kiện click vào file để không nhảy vào detail
                              _handleOpenFile(context, fileData, fileName ?? 'document');
                            },
                            child: isImage
