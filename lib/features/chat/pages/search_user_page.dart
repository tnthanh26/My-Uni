          ...
          : StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                final filteredUsers = docs.where((doc) {
                  ...
                  final mssv =
                      (data['studentId'] ?? data['mssv'] ?? data['code'] ?? '')
                          .toString()
                          .trim()
                          .toLowerCase();
                  ...
                  final cleanQuery = _removeVietnameseDiacritics(q);

                  final cleanName = _removeVietnameseDiacritics(name);

                  final isMssvMatch = q.isNotEmpty && q == mssv;

                  final isEmailMatch =
                      q.isNotEmpty && (q == email || q == emailPrefix);

                  final isNameMatch =
                      q.isNotEmpty && (q == name || cleanQuery == cleanName);

                  return isMssvMatch || isEmailMatch || isNameMatch;
                }).toList();
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          try {
                            ...
                            debugPrint('Không thể tạo phòng chat: $e');
