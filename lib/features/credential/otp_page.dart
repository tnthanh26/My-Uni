  ...
  Future<void> _verifyAndSignUp(Map<String, dynamic> args) async {
    ...
    try {
      ...
      final verifyUrl = Uri.parse(
        'https://asia-southeast1-myuni-fe6d1.cloudfunctions.net/verifyOTPAndCreateUser',
      );
      final response = await http
          .post(
            verifyUrl,
      ...
      if (mounted) {
        _showSnackBar(
          'Quá trình phản hồi từ máy chủ mất nhiều thời gian. Vui lòng thử bấm Xác nhận lại.',
          isError: true,
        );
      }
    } catch (e) {
